...
#define EFFECT_START_CASE(name) case EFFECT_##name: return effect_##name##_Start(mod, channel, ecol, note)
#define EFFECT_PROCESS_CASE(name) case EFFECT_##name: return effect_##name##_Process(mod, channel, ecol)
#define EFFECT_STOP_CASE(name) case EFFECT_##name: return effect_##name##_Stop(mod, channel, ecol)

int MODPLAY_CallEffectStart(u16 effect, MODFILE *mod, int channel, int ecol, MOD_Note *note) {
	switch (effect) {
	case EFFECT_NONE: return effect_None_Start(mod, channel, ecol, note);
	EFFECT_START_CASE(ST00);
	EFFECT_START_CASE(ST10);
	EFFECT_START_CASE(ST20);
	EFFECT_START_CASE(ST30);
	EFFECT_START_CASE(ST40);
	EFFECT_START_CASE(ST50);
	EFFECT_START_CASE(ST60);
	EFFECT_START_CASE(ST70);
	EFFECT_START_CASE(ST80);
	EFFECT_START_CASE(ST90);
	EFFECT_START_CASE(STa0);
	EFFECT_START_CASE(STb0);
	EFFECT_START_CASE(STc0);
	EFFECT_START_CASE(STd0);
	EFFECT_START_CASE(STe1);
	EFFECT_START_CASE(STe2);
	EFFECT_START_CASE(STe4);
	EFFECT_START_CASE(STe5);
	EFFECT_START_CASE(STe6);
	EFFECT_START_CASE(STe7);
	EFFECT_START_CASE(STe8);
	EFFECT_START_CASE(STe9);
	EFFECT_START_CASE(STea);
	EFFECT_START_CASE(STeb);
	EFFECT_START_CASE(STec);
	EFFECT_START_CASE(STed);
	EFFECT_START_CASE(STee);
	EFFECT_START_CASE(STef);
	EFFECT_START_CASE(STf0);
	EFFECT_START_CASE(STg0);
	EFFECT_START_CASE(XM01);
	EFFECT_START_CASE(XM02);
	EFFECT_START_CASE(XM10);
	EFFECT_START_CASE(XM11);
	EFFECT_START_CASE(XM19);
	EFFECT_START_CASE(XMa0);
	EFFECT_START_CASE(S3Ma0);
	EFFECT_START_CASE(S3Md0);
	EFFECT_START_CASE(S3Me0);
	EFFECT_START_CASE(S3Mf0);
	EFFECT_START_CASE(S3Mk0);
	EFFECT_START_CASE(S3Ml0);
	EFFECT_START_CASE(S3Mq0);
	EFFECT_START_CASE(S3Mr0);
	EFFECT_START_CASE(S3Mt0);
	default:
		return 0;
	}
}
...
int MODPLAY_CallEffectProcess(u16 effect, MODFILE *mod, int channel, int ecol) {
	switch (effect) {
	case EFFECT_NONE: return effect_None_Process(mod, channel, ecol);
	EFFECT_PROCESS_CASE(ST00);
	EFFECT_PROCESS_CASE(ST10);
	EFFECT_PROCESS_CASE(ST20);
	EFFECT_PROCESS_CASE(ST30);
	EFFECT_PROCESS_CASE(ST40);
	EFFECT_PROCESS_CASE(ST50);
	EFFECT_PROCESS_CASE(ST60);
	EFFECT_PROCESS_CASE(ST70);
	EFFECT_PROCESS_CASE(ST80);
	EFFECT_PROCESS_CASE(ST90);
	EFFECT_PROCESS_CASE(STa0);
	EFFECT_PROCESS_CASE(STb0);
	EFFECT_PROCESS_CASE(STc0);
	EFFECT_PROCESS_CASE(STd0);
	EFFECT_PROCESS_CASE(STe1);
	EFFECT_PROCESS_CASE(STe2);
	EFFECT_PROCESS_CASE(STe4);
	EFFECT_PROCESS_CASE(STe5);
	EFFECT_PROCESS_CASE(STe6);
	EFFECT_PROCESS_CASE(STe7);
	EFFECT_PROCESS_CASE(STe8);
	EFFECT_PROCESS_CASE(STe9);
	EFFECT_PROCESS_CASE(STea);
	EFFECT_PROCESS_CASE(STeb);
	EFFECT_PROCESS_CASE(STec);
	EFFECT_PROCESS_CASE(STed);
	EFFECT_PROCESS_CASE(STee);
	EFFECT_PROCESS_CASE(STef);
	EFFECT_PROCESS_CASE(STf0);
	EFFECT_PROCESS_CASE(STg0);
	EFFECT_PROCESS_CASE(XM01);
	EFFECT_PROCESS_CASE(XM02);
	EFFECT_PROCESS_CASE(XM10);
	EFFECT_PROCESS_CASE(XM11);
	EFFECT_PROCESS_CASE(XM19);
	EFFECT_PROCESS_CASE(XMa0);
	EFFECT_PROCESS_CASE(S3Ma0);
	EFFECT_PROCESS_CASE(S3Md0);
	EFFECT_PROCESS_CASE(S3Me0);
	EFFECT_PROCESS_CASE(S3Mf0);
	EFFECT_PROCESS_CASE(S3Mk0);
	EFFECT_PROCESS_CASE(S3Ml0);
	EFFECT_PROCESS_CASE(S3Mq0);
	EFFECT_PROCESS_CASE(S3Mr0);
	EFFECT_PROCESS_CASE(S3Mt0);
	default:
		return 0;
	}
}
...
int MODPLAY_CallEffectStop(u16 effect, MODFILE *mod, int channel, int ecol) {
	switch (effect) {
	case EFFECT_NONE: return effect_None_Stop(mod, channel, ecol);
	EFFECT_STOP_CASE(ST00);
	EFFECT_STOP_CASE(ST10);
	EFFECT_STOP_CASE(ST20);
	EFFECT_STOP_CASE(ST30);
	EFFECT_STOP_CASE(ST40);
	EFFECT_STOP_CASE(ST50);
	EFFECT_STOP_CASE(ST60);
	EFFECT_STOP_CASE(ST70);
	EFFECT_STOP_CASE(ST80);
	EFFECT_STOP_CASE(ST90);
	EFFECT_STOP_CASE(STa0);
	EFFECT_STOP_CASE(STb0);
	EFFECT_STOP_CASE(STc0);
	EFFECT_STOP_CASE(STd0);
	EFFECT_STOP_CASE(STe1);
	EFFECT_STOP_CASE(STe2);
	EFFECT_STOP_CASE(STe4);
	EFFECT_STOP_CASE(STe5);
	EFFECT_STOP_CASE(STe6);
	EFFECT_STOP_CASE(STe7);
	EFFECT_STOP_CASE(STe8);
	EFFECT_STOP_CASE(STe9);
	EFFECT_STOP_CASE(STea);
	EFFECT_STOP_CASE(STeb);
	EFFECT_STOP_CASE(STec);
	EFFECT_STOP_CASE(STed);
	EFFECT_STOP_CASE(STee);
	EFFECT_STOP_CASE(STef);
	EFFECT_STOP_CASE(STf0);
	EFFECT_STOP_CASE(STg0);
	EFFECT_STOP_CASE(XM01);
	EFFECT_STOP_CASE(XM02);
	EFFECT_STOP_CASE(XM10);
	EFFECT_STOP_CASE(XM11);
	EFFECT_STOP_CASE(XM19);
	EFFECT_STOP_CASE(XMa0);
	EFFECT_STOP_CASE(S3Ma0);
	EFFECT_STOP_CASE(S3Md0);
	EFFECT_STOP_CASE(S3Me0);
	EFFECT_STOP_CASE(S3Mf0);
	EFFECT_STOP_CASE(S3Mk0);
	EFFECT_STOP_CASE(S3Ml0);
	EFFECT_STOP_CASE(S3Mq0);
	EFFECT_STOP_CASE(S3Mr0);
	EFFECT_STOP_CASE(S3Mt0);
	default:
		return 0;
	}
}

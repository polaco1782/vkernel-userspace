	...
	uint32_t trA)
{
	...
	return abs(static_cast<int>((ayuv1 >> 24) & 0xFFU) - static_cast<int>((ayuv2 >> 24) & 0xFFU)) > static_cast<int>(trA) ||
		abs(static_cast<int>((ayuv1 >> 16) & 0xFFU) - static_cast<int>((ayuv2 >> 16) & 0xFFU)) > static_cast<int>(trY) ||
		abs(static_cast<int>((ayuv1 >> 8) & 0xFFU) - static_cast<int>((ayuv2 >> 8) & 0xFFU)) > static_cast<int>(trU) ||
		abs(static_cast<int>(ayuv1 & 0xFFU) - static_cast<int>(ayuv2 & 0xFFU)) > static_cast<int>(trV);
}
